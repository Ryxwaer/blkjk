...
<template>
  ...
  >
    ...
    <main class="relative z-10 flex-1 min-h-0 flex flex-col items-center justify-center gap-3 sm:gap-12 px-3 pt-2 sm:pt-6 pb-48 sm:pb-40 overflow-hidden">
      <div class="absolute left-3 sm:left-10 top-1/2 -translate-y-1/2 z-20">
        <Deck />
      </div>
    ...
    <div class="absolute inset-x-0 bottom-0 z-20 pointer-events-none">
      <div class="pointer-events-auto">
        <BetControls :show-odds="props.showOdds" />
      </div>
    </div>
  </div>
</template>
